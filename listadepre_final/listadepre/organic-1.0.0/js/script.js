(function($) {
  ...
  $(function() {
    $('.btn-plus').click(function() {
      var container = $(this).closest('.button-area');
      var valueSpan = container.find('.gift-value');
    ...
    $('.btn-gift').click(function(e) {
      e.preventDefault();
      var container = $(this).closest('.button-area');
      var value = container.find('.gift-value').text();
      container.find('.pix-value').text('R$' + value);
      container.find('.gift-box').slideToggle();
    });
  });
